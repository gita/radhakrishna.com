...
A living doc. Everything we figure out while rebuilding Radhakrishna.com that should feed the
**bhagavadgita.com** website and app upgrade later. Keep appending. When that work starts, port this into
`bg-frontend` (and the app repo).
